 ...
 const radioButton =document.getElementById('.payment')
...
-
 ...
 const nametag=document.getElementById("name");
        ...
        paymentButton.addEventListener("click",(event)=>{
          ...
          if(nameerror.innerHTML||streeterror.innerHTML||landmarkerror.innerHTML||pincodeerror.innerHTML||cityerror.innerHTML||stateerror.innerHTML||emailerror.innerHTML|| phoneerror.innerHTML||countryerror.innerHTML||(!radioButton)){
